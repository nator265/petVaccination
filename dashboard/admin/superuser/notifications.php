                        ...
                        <table>
                            ...
                            <?php
                                ...
                                // retrieving data from the database for the user to see
                                 $retrieve = "SELECT users.fullname as name, notifications.sender, notifications.title, notifications.message, notifications.time, notifications.id FROM users INNER JOIN notifications ON users.field = notifications.field where notifications.phone = '".$_SESSION['phone']."'";
